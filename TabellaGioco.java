...
// creazione JFrame
	...
	public TabellaGioco() {
		...
		JLabel s = new JLabel("New label");
		s.setIcon(new ImageIcon("C:\\Users\\Francesco\\Desktop\\unnamed.png"));
		s.setBounds(14, 0, 514, 131);
		contentPane.add(s);
	...
	JButton btnConferma = new JButton("CONFERMA");
		...
		btnConferma.setBounds(392, 231, 105, 91);
		...
		lblTimer.setBounds(372, 145, 46, 14);
        ...
        minuts.setBounds(422, 198, 18, 20);
        contentPane.add(minuts);
        
        JLabel dueponti = new JLabel(":");
        dueponti.setBounds(443, 197, 4, 23);
        contentPane.add(dueponti);
